...
class CodeGenerator:
    ...
    def classSetup(self):
        ...
        self.code = [(0,"import os"),(0,"import unittest"),(0, "import psycopg2")]
    ...
    def dbobjectTests(self):
        pass # check each dbobject, add a test
