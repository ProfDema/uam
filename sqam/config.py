...
preamble_cmd = ('''cp %s .; cp %s .''' %
                (os.path.join(path_to_uam, 'pam', 'examples', 'TestA1.py'),
                 os.path.join(path_to_uam, 'pam', 'examples', 'sqam_util.py')))
#preamble_cmd = '''python3 sqam_preprocessor.py'''
...
#   directory or None.
postamble_cmd = 'rm -rf __pycache__'
